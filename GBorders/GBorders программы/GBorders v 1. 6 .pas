...
begin
    //Главное окнo
        ...
        //Первый бордюр
        for var i := 0 to WindowWidth div w - 2 do
        begin
            pic.Draw(i * w, 30, w, h);
        end;
        //Второй бордюр
        ...
        begin
            ...
            pic.Draw(i * w + w, 30 + h * 8 + 20 * 5, -w, h);
        end;
        //Седьмой бордюр
        for var i := 0 to WindowWidth div w - (w div 2) + 1  do
        begin
...
begin
    ...
    pic := picture.Create('Снимок3.PNG');
        setpencolor(clwhite);
        rectangle(window.Width div 150, 0, window.Width div 100, window.Height);
    //Первый бордюр
        for var i := 0 to WindowWidth div w do
        begin
            pic.Draw(i * w, 30, w, h);
        end;
        //Второй бордюр
