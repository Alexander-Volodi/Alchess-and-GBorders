...
begin
    ...
    SetWindowCaption('GBorders v 1. 1');
    var pic: picture;
    var w, h, N, r, c, score, attempt: integer;
    w := 507 div 10;
    h := 494 div 10;
    N := 7;
            ...
            0:
                begin
                    ...
                    begin
                        ...
                        begin
                            case score of
                                0..6: textout(900, 180, 'I advise repeating theory!');
                                7..8: textout(900, 180, 'You know this topic, but i advise repeating theory because you can forget borders.');
                                9..10: textout(900, 180, 'You know all topic.');
                            end;
                            sleep(3000);
                            closewindow;
                        end;
