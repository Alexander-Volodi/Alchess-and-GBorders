    ...
    begin
        ...
        begin
            ...
            begin
                ...
                clearwindow(RGB(200,200,200));
                setbrushcolor(RGB(200,200,200));
                textout(50,100,'Border can''t be with shorter or longer indent than indent floor.');
                textout(200,150,'If the border is double then the lower half');
                textout(275,200,'is mirrored from the upper half.');
                var e := new ButtonABC(420,350,100,100,'End',RGB(255,255,255));
                e.OnClick := procedure ->
                begin
                    e.Destroy;
                    d.Visible:=true;
